...
This document defines the Git workflow, branching strategy, commit conventions, and merge procedures for the ios-builder.

## Git Agent Overview

The Git Agent manages version control operations and GitHub interactions for the ios-builder.
