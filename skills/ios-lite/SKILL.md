...
Use **ios-full-pipeline** instead if you need configurable stages, cross-run learning, or production deploy.
...
## When to Upgrade to ios-full-pipeline

Consider **ios-full-pipeline** if you need:
