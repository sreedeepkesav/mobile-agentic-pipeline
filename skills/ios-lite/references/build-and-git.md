...
- `/sessions/cool-happy-noether/mnt/outputs/mobile-agentic-pipeline/skills/ios-lite/SKILL.md` — Full pipeline overview
- `/sessions/cool-happy-noether/mnt/outputs/mobile-agentic-pipeline/skills/ios-lite/references/feedback-loops.md` — Feedback loops (including Build fail loop)
- `/sessions/cool-happy-noether/mnt/outputs/mobile-agentic-pipeline/skills/ios-lite/references/ios-standards.md` — Standards that Build/Git verify
