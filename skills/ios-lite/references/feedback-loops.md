...
- `/sessions/cool-happy-noether/mnt/outputs/mobile-agentic-pipeline/skills/ios-lite/SKILL.md` — Overview of all feedback loops
- `/sessions/cool-happy-noether/mnt/outputs/mobile-agentic-pipeline/skills/ios-lite/references/build-and-git.md` — Build and Git phase details
- `/sessions/cool-happy-noether/mnt/outputs/mobile-agentic-pipeline/skills/ios-lite/references/code-gen-phases.md` — 4-phase Coder (where some loops trigger)
