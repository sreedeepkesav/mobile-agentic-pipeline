...
- `/sessions/cool-happy-noether/mnt/outputs/mobile-agentic-pipeline/skills/ios-lite/references/ios-standards.md` — Standards each phase follows
- `/sessions/cool-happy-noether/mnt/outputs/mobile-agentic-pipeline/skills/ios-lite/references/ios-architecture-template.md` — Code templates
