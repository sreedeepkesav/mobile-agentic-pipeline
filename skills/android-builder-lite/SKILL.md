...
description: >
  ...
  Invoke explicitly: "use android-builder-lite", "run android-builder-lite", "start android-builder-lite".
  Not for: production apps needing configurable stages or cross-run
  learning — use android-builder instead.
---
...
Use **android-builder** instead if you need configurable stages, cross-run learning, or production deploy.
...
## When to Upgrade to android-builder

Consider **android-builder** if you need:
